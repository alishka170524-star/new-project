  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 pb-20 pt-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:pb-28 lg:pt-24">
          <div className="max-w-xl">
            ...
            <h1 className="animate-fade-up mt-6 font-heading text-4xl font-bold leading-[1.08] tracking-tight text-foreground sm:text-6xl" style={{ animationDelay: "90ms" }}>
              {hero.titleLine1}
            ...
            <div className="animate-fade-up mt-8 flex flex-wrap gap-3" style={{ animationDelay: "270ms" }}>
              <Link to="/shop" className="btn btn-accent !px-7 !py-3.5 text-sm">
                Shop the collection <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </Link>
              <Link to="/shop?category=cues" className="btn btn-outline text-sm">
                Browse cues
              </Link>
            </div>
          ...
          <div className="relative mx-auto w-full max-w-md lg:max-w-none">
            <div className="absolute -inset-6 rounded-[2.5rem] bg-gold-400/15 blur-2xl" aria-hidden="true" />
            <div className="relative overflow-hidden rounded-[2rem] border border-border bg-surface-2 p-3 shadow-lift">
              <div
                role="group"
      ...
      <section aria-label="Partners" className="mx-auto max-w-7xl px-4 pt-10 sm:px-6">
        <SponsorSlot placement="home_hero" />
              ...
              {activeSponsors.map((s) => (
                <li key={s.id}>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group flex items-center gap-2.5 rounded-full border border-border bg-surface-2 py-1.5 pl-1.5 pr-5 shadow-soft transition-all duration-200 hover:-translate-y-0.5 hover:border-gold-400 hover:shadow-gold"
                  >
                    {s.image ? (
                      ...
                      <span
                        aria-hidden="true"
                        className="h-9 w-9 shrink-0 rounded-full bg-gradient-to-br from-gold-300 to-gold-600"
                      />
                    )}
                    <span className="font-heading text-sm font-bold text-foreground/80 transition-colors duration-200 group-hover:text-gold-300">
                      {s.name}
                    </span>
                    <ExternalLink
                      className="h-3.5 w-3.5 text-foreground/40 transition-colors duration-200 group-hover:text-gold-400"
                      aria-hidden="true"
                    />
                  </a>
                </li>
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-3 p-5">
                      <div className="text-on-primary">
                        ...
                        <p className="mt-0.5 text-xs text-on-primary/75">{c.blurb}</p>
