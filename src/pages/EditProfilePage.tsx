...
export default function EditProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      {notice && (
        <p role="status" className="mt-6 flex items-start gap-2.5 rounded-xl border border-primary/25 bg-primary/10 px-4 py-3 text-sm font-semibold text-primary-200">
      ...
      <form onSubmit={saveProfile} className="card mt-6 space-y-5 p-6" noValidate>
        <div className="flex items-center gap-3">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-primary/10 text-primary-200">
      ...
      <form onSubmit={savePassword} className="card mt-6 space-y-5 p-6" noValidate>
        <div className="flex items-center gap-3">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-gold-100 text-gold-300">
