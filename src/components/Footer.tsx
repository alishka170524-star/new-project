...
export default function Footer() {
  const { categories, pages, siteConfig } = useConfig();
  ...
  return (
    <footer className="relative overflow-hidden border-t border-primary-800/60 bg-primary-950 text-on-primary print:hidden">
      <div
