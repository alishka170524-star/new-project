  ...
  return (
    <header className="sticky top-0 z-40 print:hidden">
      ...
      >
        ...
        <p className="relative mx-auto flex max-w-7xl items-center justify-center gap-2.5 px-4 py-2 text-center text-[11px] font-semibold tracking-wide sm:text-xs">
      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:h-[4.5rem] sm:px-6">
          <Link to="/" className="group flex items-center gap-2.5" aria-label="ISAK Billiard Co. home">
            <BrandMark className="h-10 w-10 transition-transform duration-200 group-hover:scale-105" />
          ...
          <div className="flex items-center gap-1 sm:gap-1.5">
            ...
            <Link
              ...
              className="btn btn-ghost !px-2.5 sm:!px-3"
            >
              <Search className="h-[1.15rem] w-[1.15rem]" aria-hidden="true" />
            </Link>
            <Link
              to="/cart"
              className="relative btn btn-ghost !px-2.5 sm:!px-3"
      ...
      {open && (
        <div className="md:hidden" id="mobile-nav" role="dialog" aria-modal="true" aria-label="Menu">
          ...
          <div className="fixed inset-y-0 left-0 z-50 flex w-[19rem] max-w-[85vw] flex-col overflow-hidden rounded-r-3xl bg-background shadow-lift">
            ...
            <div className="border-t border-border bg-white/10 p-4">
              {user ? (
