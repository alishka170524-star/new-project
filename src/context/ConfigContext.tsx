...
export const DEFAULT_HERO: HeroConfig = {
  ...
  images: ["/placeholders/table.svg", "/placeholders/balls.svg", "/placeholders/cue.svg"],
};
...
export function ConfigProvider({ children }: { children: ReactNode }) {
  ...
  const [partners, setPartners] = useState<PartnerConfig[]>(() =>
    readJson(PARTNERS_KEY, DEFAULT_PARTNERS)
  );
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (!error && data?.config && typeof data.config === "object") {
        ...
        if (Array.isArray(bundle.partners)) setPartners(bundle.partners);
  ...
  }, [paymentGateways, categories, pages, sponsors, partners, siteConfig, posts, logo, hydratedRef.current]);
