...
export const SEED_REVIEWS: ProductReview[] = [
  {
    ...
    media: [{ kind: "image", dataUrl: "/placeholders/cue.svg" }],
  ...
  },
  {
    ...
    media: [
      { kind: "image", dataUrl: "/placeholders/cue.svg" },
      { kind: "image", dataUrl: "/placeholders/table.svg" },
    ],
  ...
  },
  {
    ...
    media: [{ kind: "image", dataUrl: "/placeholders/table.svg" }],
  ...
  },
  {
    ...
    media: [{ kind: "image", dataUrl: "/placeholders/accessories.svg" }],
  ...
  },
  {
    ...
    media: [{ kind: "image", dataUrl: "/placeholders/glove.svg" }],
  ...
  },
  {
    ...
    media: [
      { kind: "image", dataUrl: "/placeholders/balls.svg" },
      { kind: "image", dataUrl: "/placeholders/table.svg" },
    ],
